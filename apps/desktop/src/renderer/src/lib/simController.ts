...
export class SimController {
  ...
  constructor(
    ...
    private cfg: { season: SeasonConfig; mat: MatPayload | null; robot: RobotModel; start: StartPose; fieldModels: FieldModel[]; footprints: boolean; colorCalibration?: ColorCalibration },
  ) {
  ...
  boot() {
    ...
    this.send({ type: "init", season: this.cfg.season, mat, robot: this.cfg.robot, start: this.cfg.start, ctrl: this.ctrlBuf, fieldModels: this.cfg.fieldModels, footprints: this.cfg.footprints, colorCalibration: this.cfg.colorCalibration });
  }
